...
import GetNotesComponent from "./GetCertificateComponent copy 2";
import GetCalendarComponent from "./GetCertificateComponent copy";
    ...
    return (
      <div className="container">
        <ul class="nav nav-tabs customNavTab">
          ...
          <li class="nav-item">
            <div className="dropdown">
              <span className="nav-link customNavTab">Notes</span>
              <div className="dropdown-content">
                <Link onClick={this.notesHandler}>
                  <span>Get Notes</span>
                </Link>
              </div>
            </div>
          ...
          <li class="nav-item">
            <div className="dropdown">
              <span className="nav-link customNavTab">Calendar</span>
              <div className="dropdown-content">
                <Link onClick={this.calendarHandler}>
                  <span>Get Calendar</span>
                </Link>
              </div>
            </div>
          </li>
